...
python3 "$DIR/extract.py" "$HTML" "$TMP/app.js" \
  ...
  invmIsWLot invmFmtDate invmIsRepackLot invmSortLots invmFilterLots invmLotAgeDays invmFefoSort invmInvReportPhysical invmParseInventoryReport invmInvReportIsBpLot invmInvReportPlan bpCcId ooDateToISO \
