...
python3 "$DIR/extract.py" "$HTML" "$TMP/app.js" \
  ...
  dmISOLocal bpFutureWeeks bpWeeksOfCover cmPlanEntries dmWeekPace bpSnapWeekDemand renderWeekPanel hybridSalesForWeek dsNamesFor dsLabelFor jlzSyncScope getActiveOrigin \
