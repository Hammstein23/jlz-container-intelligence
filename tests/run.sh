...
python3 "$DIR/extract.py" "$HTML" "$TMP/app.js" \
  ...
  bpInvLot bpOrderById bpOrderCifLb bpOrderPerCaseLb bpInvRate bpDaysSince bpEtaOf invmCanonSku bpArrivalNetCases bpGetPipelineByWeek ordAfterBoughtForChange ordMergeLocalOnly _mtoMarkList _mtoMarksMap getOrders saveOrders simGingerPeruOrders simRenderProduct
