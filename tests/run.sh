...
for _c in DM_SELL_DAYS BP_INV_LS BP_INV_LS_V1 BP_PE_CALENDAR CODY_PRODUCTS WLOT_SNAP_LS WLOT_TONE WLOT_TONE_TITLE WLOT_FILTER _invmOrigDemandCache MKT_LS MKT_RULE_NOTE _mktCtx INVM_REVIEW_DAYS INVM_REVIEW_FILTER INVM_REVIEW_CLOCK; do
